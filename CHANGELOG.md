...
## [17.5.0](https://github.com/georgeharker/codecompanion.nvim/compare/v17.23.0...v17.5.0) (2025-10-02)


### ⚠ BREAKING CHANGES

* remove support for nvim-0.10 ([#1639](https://github.com/georgeharker/codecompanion.nvim/issues/1639))
* **chat:** move the `goto_file_action` to `strategies.chat.opts`
* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/georgeharker/codecompanion.nvim/issues/1571))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/georgeharker/codecompanion.nvim/issues/1569))
...
* **action_palette:** add `fzf_lua` provider ([#1443](https://github.com/georgeharker/codecompanion.nvim/issues/1443)) ([03caa41](https://github.com/georgeharker/codecompanion.nvim/commit/03caa41555d6615006d0ac8f6fcfee317cb967f0))
* **action_palette:** Add snacks.nvim as provider ([#1380](https://github.com/georgeharker/codecompanion.nvim/issues/1380)) ([5b4a004](https://github.com/georgeharker/codecompanion.nvim/commit/5b4a004ea082a0608aa98bb9041f79e56676cfeb))
...
* **adapters:** add gemini-2.5-pro-preview-06-05 ([#1605](https://github.com/georgeharker/codecompanion.nvim/issues/1605)) ([fa8af3b](https://github.com/georgeharker/codecompanion.nvim/commit/fa8af3bbaa70773a5d104ad8fdc567d30be260b4))
* **adapters:** add new Anthropic models ([#1488](https://github.com/georgeharker/codecompanion.nvim/issues/1488)) ([70d52e0](https://github.com/georgeharker/codecompanion.nvim/commit/70d52e00c23a6df9ccf3bc927e2658b320764302))
...
* **adapters:** add vision support ([#1455](https://github.com/georgeharker/codecompanion.nvim/issues/1455)) ([1a4f0a4](https://github.com/georgeharker/codecompanion.nvim/commit/1a4f0a44b1e52d1c569ce2f66b03b6804e74b183))
...
* **adapters:** can automatically choose default model when switching adapters ([#1369](https://github.com/georgeharker/codecompanion.nvim/issues/1369)) ([90e82ab](https://github.com/georgeharker/codecompanion.nvim/commit/90e82abf4d65b64b0986a5be0981ba13e84eee8b))
* **adapters:** can use adapter.opts.request to override Client:request ([#1469](https://github.com/georgeharker/codecompanion.nvim/issues/1469)) ([ec73b64](https://github.com/georgeharker/codecompanion.nvim/commit/ec73b64df3d0767eb0a5b42d942f9e02970ee95c))
* **adapters:** new copilot default is gpt-4.1 ([#1540](https://github.com/georgeharker/codecompanion.nvim/issues/1540)) ([15b0614](https://github.com/georgeharker/codecompanion.nvim/commit/15b06141cb9d66ebb3b3038fbe4fa9cd0ee0fc15))
...
* **adapters:** set Copilot default model to `gpt-4.1` ([bd14edb](https://github.com/georgeharker/codecompanion.nvim/commit/bd14edb82ea07423c5c0f7484ef885a895374719))
* **adapters:** support Copilot enterprise ([#1533](https://github.com/georgeharker/codecompanion.nvim/issues/1533)) ([7572e35](https://github.com/georgeharker/codecompanion.nvim/commit/7572e35f22395ad2ab095e75b419a70a00ca2036))
...
* **adapters:** users can specify models for strategies ([#1518](https://github.com/georgeharker/codecompanion.nvim/issues/1518)) ([763c81b](https://github.com/georgeharker/codecompanion.nvim/commit/763c81b4823af3e3ef9cfb3f55f15f7f8f8b4b15))
...
* **chat:** add `collapse_tools` setting for tool groups ([#1614](https://github.com/georgeharker/codecompanion.nvim/issues/1614)) ([f1442c7](https://github.com/georgeharker/codecompanion.nvim/commit/f1442c743f0f40132d07b42ccf99e450b648fcf6))
...
* **chat:** add keymap to jump to file under cursor ([#1408](https://github.com/georgeharker/codecompanion.nvim/issues/1408)) ([4c54348](https://github.com/georgeharker/codecompanion.nvim/commit/4c5434883fff08bc9814fb71aff0f51518276acb))
...
* **chat:** call slash commands with keymaps ([#1412](https://github.com/georgeharker/codecompanion.nvim/issues/1412)) ([598af68](https://github.com/georgeharker/codecompanion.nvim/commit/598af68b53394cfd43f7a098dcd463da86c5dc3f))
* **chat:** can preload with `default_tools` ([#1610](https://github.com/georgeharker/codecompanion.nvim/issues/1610)) ([68c12a0](https://github.com/georgeharker/codecompanion.nvim/commit/68c12a03a738aaeffe429c45b9f0c14ce00b0132))
* **chat:** can set default params for variables ([#1516](https://github.com/georgeharker/codecompanion.nvim/issues/1516)) ([c0549d5](https://github.com/georgeharker/codecompanion.nvim/commit/c0549d54203160020b4214d3e8827b2103a95b97))
* **chat:** chat buffer acts more like a normal buffer ([#1556](https://github.com/georgeharker/codecompanion.nvim/issues/1556)) ([ebcdd78](https://github.com/georgeharker/codecompanion.nvim/commit/ebcdd78a9d5d0d95c64fe9a106999b9f9603d2f3))
...
* **chat:** remember cursor position when toggling ([#1523](https://github.com/georgeharker/codecompanion.nvim/issues/1523)) ([51fb1df](https://github.com/georgeharker/codecompanion.nvim/commit/51fb1dfa7227ace2e6635c8fcc75cc2ab1b607c6))
* **chat:** reuse existing tabs when jumping to a file. ([#1569](https://github.com/georgeharker/codecompanion.nvim/issues/1569)) ([8747d88](https://github.com/georgeharker/codecompanion.nvim/commit/8747d8871e310942996431d5374001a8b29ab0b7))
* **chat:** simplify watchers to use unified diffs ([#1583](https://github.com/georgeharker/codecompanion.nvim/issues/1583)) ([81b817b](https://github.com/georgeharker/codecompanion.nvim/commit/81b817b4186f85d4b2880516054b0e34bb27e60d))
* **chat:** support `:map-arguments` in keymaps ([#1572](https://github.com/georgeharker/codecompanion.nvim/issues/1572)) ([d8e94cf](https://github.com/georgeharker/codecompanion.nvim/commit/d8e94cfff7525ff5fdcc376093666c2cf57bb0e5))
...
* **prompt_library:** custom prompts can add references ([#1384](https://github.com/georgeharker/codecompanion.nvim/issues/1384)) ([3117350](https://github.com/georgeharker/codecompanion.nvim/commit/31173502852f0d524e9e74e51255177f094c45e0))
...
* **providers:** add coc.nvim ([#1421](https://github.com/georgeharker/codecompanion.nvim/issues/1421)) ([c22d2a6](https://github.com/georgeharker/codecompanion.nvim/commit/c22d2a675f76a97ede327a49baddec02ecd6f3f5))
...
* **slash_command:** new `/quickfix` command ([#1600](https://github.com/georgeharker/codecompanion.nvim/issues/1600)) ([6384dc0](https://github.com/georgeharker/codecompanion.nvim/commit/6384dc0d5b150394403e5ab3bc89bfad301634ea))
* **slash_commands:** add Telescope provider for `/image` ([#1542](https://github.com/georgeharker/codecompanion.nvim/issues/1542)) ([a12d3aa](https://github.com/georgeharker/codecompanion.nvim/commit/a12d3aa9a0825ae72733fcffc646615bc3bee484))
* **slash_commands:** better caching and restoring of URLs ([#1491](https://github.com/georgeharker/codecompanion.nvim/issues/1491)) ([d39890c](https://github.com/georgeharker/codecompanion.nvim/commit/d39890cb432801cfe5b2a97104289e1cc4b9c415))
* **slash_commands:** for `/fetch` only show cache option if cached files exist ([#1582](https://github.com/georgeharker/codecompanion.nvim/issues/1582)) ([f022807](https://github.com/georgeharker/codecompanion.nvim/commit/f0228073aeb2b577425ace676c34654b2e1a308d))
* **tools:** `[@editor](https://github.com/editor)` tool merges with `[@insert](https://github.com/insert)_edit_into_file` ([#1586](https://github.com/georgeharker/codecompanion.nvim/issues/1586)) ([bec6cd1](https://github.com/georgeharker/codecompanion.nvim/commit/bec6cd124da650dc25472e03f4416cbe27574ef8))
...
* **tools:** add `[@next](https://github.com/next)_edit_suggestion` tool ([#1570](https://github.com/georgeharker/codecompanion.nvim/issues/1570)) ([600e7b2](https://github.com/georgeharker/codecompanion.nvim/commit/600e7b2d55816fa3b8103ef898aaaa31a224224f))
...
* **tools:** add `file_search` tool ([#1613](https://github.com/georgeharker/codecompanion.nvim/issues/1613)) ([3582a2c](https://github.com/georgeharker/codecompanion.nvim/commit/3582a2c465fe8900ad70e24877d48247abd608c9))
...
* **tools:** add `grep_search` tool ([#1651](https://github.com/georgeharker/codecompanion.nvim/issues/1651)) ([98eb86c](https://github.com/georgeharker/codecompanion.nvim/commit/98eb86cd5e66aa0f2bc3c47eb699ea81c99b74db))
...
* **tools:** add tavily adapter and `[@web](https://github.com/web)_search` tool ([#1279](https://github.com/georgeharker/codecompanion.nvim/issues/1279)) ([a5a8701](https://github.com/georgeharker/codecompanion.nvim/commit/a5a8701bf8814ff0ba9bf5f76b3a3deedf3e5f28))
* **tools:** auto_tool_mode now auto submits ([#1580](https://github.com/georgeharker/codecompanion.nvim/issues/1580)) ([1b2ab64](https://github.com/georgeharker/codecompanion.nvim/commit/1b2ab6445dac16908b2136bd7c071e4dcb7f38d6))
* **tools:** can be conditionally loaded ([#1647](https://github.com/georgeharker/codecompanion.nvim/issues/1647)) ([40ba4fc](https://github.com/georgeharker/codecompanion.nvim/commit/40ba4fc7e7749a089f23123593d9a6c85140fcfc))
* **tools:** can load tools via relative paths ([#1552](https://github.com/georgeharker/codecompanion.nvim/issues/1552)) ([7991e53](https://github.com/georgeharker/codecompanion.nvim/commit/7991e53c0270db489b94e1a26c0d1608aa2d6206))
* **tools:** improve auto-submit and turn on by default ([#1539](https://github.com/georgeharker/codecompanion.nvim/issues/1539)) ([3388e15](https://github.com/georgeharker/codecompanion.nvim/commit/3388e1562aaa6d6deab90e8ad141439ed2bcac2f))
...
* **adapters:** enable OpenAI vision support ([#1486](https://github.com/georgeharker/codecompanion.nvim/issues/1486)) ([f8e14ae](https://github.com/georgeharker/codecompanion.nvim/commit/f8e14ae0be51c0f65b0284f787277407db30ace7))
...
* **adapters:** fix streaming for gemini adapter ([#1561](https://github.com/georgeharker/codecompanion.nvim/issues/1561)) ([585fade](https://github.com/georgeharker/codecompanion.nvim/commit/585fadef1940a66216124bdbd1bace55be3b1e73))
...
* **adapters:** improve resolving adapters ([#1367](https://github.com/georgeharker/codecompanion.nvim/issues/1367)) ([2c296ba](https://github.com/georgeharker/codecompanion.nvim/commit/2c296ba17c4bc581eee11fc90683e5b130f65d89))
...
* **adapters:** resolve adapters with correct name ([#1459](https://github.com/georgeharker/codecompanion.nvim/issues/1459)) ([0beb918](https://github.com/georgeharker/codecompanion.nvim/commit/0beb9183954ae1afa2e1f5a91812706764d1a743))
* **adapters:** resolve not using custom adapter ([#1461](https://github.com/georgeharker/codecompanion.nvim/issues/1461)) ([b79b33a](https://github.com/georgeharker/codecompanion.nvim/commit/b79b33a58304cd386f72ee0ab159824fa21321c6))
* **adapters:** resolving adapters from prompt library ([#1536](https://github.com/georgeharker/codecompanion.nvim/issues/1536)) ([9964f48](https://github.com/georgeharker/codecompanion.nvim/commit/9964f4880c66376e4c9f0d45f5fd2ab1e5496254)), closes [#1521](https://github.com/georgeharker/codecompanion.nvim/issues/1521)
* **adapters:** stack overflow if default model is function ([#1417](https://github.com/georgeharker/codecompanion.nvim/issues/1417)) ([2d28420](https://github.com/georgeharker/codecompanion.nvim/commit/2d284203ec63136f72e75a61b1cb19abb31a1ebe)), closes [#1415](https://github.com/georgeharker/codecompanion.nvim/issues/1415)
...
* **chat:** correct yank command syntax in keymaps ([#1568](https://github.com/georgeharker/codecompanion.nvim/issues/1568)) ([05555a4](https://github.com/georgeharker/codecompanion.nvim/commit/05555a40f263488592556c3acfb61ef323805136))
...
* **chat:** don't cache blink completions ([#1618](https://github.com/georgeharker/codecompanion.nvim/issues/1618)) ([8a958a4](https://github.com/georgeharker/codecompanion.nvim/commit/8a958a4a1a11e58f1eb30d378c4c88c611d388d4))
...
* **chat:** paths are always relative and wrap context in &lt;attachment&gt; ([#1633](https://github.com/georgeharker/codecompanion.nvim/issues/1633)) ([2185ccc](https://github.com/georgeharker/codecompanion.nvim/commit/2185ccc81eeb9080f6c856a408ed3cba3f2bb7ef)), closes [#1630](https://github.com/georgeharker/codecompanion.nvim/issues/1630) [#1631](https://github.com/georgeharker/codecompanion.nvim/issues/1631)
* **chat:** prevent double references in the chat buffer ([#1348](https://github.com/georgeharker/codecompanion.nvim/issues/1348)) ([aafbb62](https://github.com/georgeharker/codecompanion.nvim/commit/aafbb62c5ceb3f019610fb0e9ed3c04305b59a23))
...
* **chat:** Register cmp completions when filetype is set ([#1560](https://github.com/georgeharker/codecompanion.nvim/issues/1560)) ([3d62ac3](https://github.com/georgeharker/codecompanion.nvim/commit/3d62ac3ebe840245b157e169d06b8d87ee878dc5))
...
* **chat:** tools should be empty table if not used ([#1373](https://github.com/georgeharker/codecompanion.nvim/issues/1373)) ([3f72bac](https://github.com/georgeharker/codecompanion.nvim/commit/3f72bacfd74fc4e4b4ea07257e61ec6fb3fb004f)), closes [#1371](https://github.com/georgeharker/codecompanion.nvim/issues/1371)
...
* **chat:** various chat buffer fixes ([#1336](https://github.com/georgeharker/codecompanion.nvim/issues/1336)) ([1e2f69a](https://github.com/georgeharker/codecompanion.nvim/commit/1e2f69a9a65bd716cf897393e7af65fc74907ed8))
...
* **chat:** word boundary matching for tools and variables ([#1503](https://github.com/georgeharker/codecompanion.nvim/issues/1503)) ([f572601](https://github.com/georgeharker/codecompanion.nvim/commit/f57260190a40bb4f071d27c5386eeff1440c111b))
* **deepseek:** inline prompt to chat causes error ([#1406](https://github.com/georgeharker/codecompanion.nvim/issues/1406)) ([c912e2d](https://github.com/georgeharker/codecompanion.nvim/commit/c912e2d72a91629f554142af3e9a648e54112ca4)), closes [#1405](https://github.com/georgeharker/codecompanion.nvim/issues/1405)
...
* **inline:** "new" placement doesn't create diffview ([#1343](https://github.com/georgeharker/codecompanion.nvim/issues/1343)) ([9ab6ac1](https://github.com/georgeharker/codecompanion.nvim/commit/9ab6ac1126d89f74b9882e4343eb1397e4b052da))
* **inline:** chat placements with claude-sonnet-4 ([#1636](https://github.com/georgeharker/codecompanion.nvim/issues/1636)) ([0f82355](https://github.com/georgeharker/codecompanion.nvim/commit/0f8235523ee555daa6acc6a5e5b5c4472ed60b43)), closes [#1626](https://github.com/georgeharker/codecompanion.nvim/issues/1626)
...
* **inline:** don't modify prompts going to the chat buffer ([#1447](https://github.com/georgeharker/codecompanion.nvim/issues/1447)) ([a3b2b63](https://github.com/georgeharker/codecompanion.nvim/commit/a3b2b633c6e17f0a891713c724285843c9706e1e))
...
* **inline:** keymap modes ([#1468](https://github.com/georgeharker/codecompanion.nvim/issues/1468)) ([7ac8234](https://github.com/georgeharker/codecompanion.nvim/commit/7ac823450c490201af3362a0861c2c1c19b827a8))
...
* **inline:** remove blank lines in diffs ([#1565](https://github.com/georgeharker/codecompanion.nvim/issues/1565)) ([fee2dd1](https://github.com/georgeharker/codecompanion.nvim/commit/fee2dd137b515b779c57c915ca031921e6591d85))
* **inline:** revert keymap changes ([#1622](https://github.com/georgeharker/codecompanion.nvim/issues/1622)) ([6f89961](https://github.com/georgeharker/codecompanion.nvim/commit/6f89961632defce5a591195851569758a1e15a0e)), closes [#1621](https://github.com/georgeharker/codecompanion.nvim/issues/1621)
...
* **openai:** do not send empty tools array ([#1381](https://github.com/georgeharker/codecompanion.nvim/issues/1381)) ([33364a0](https://github.com/georgeharker/codecompanion.nvim/commit/33364a070f06e3d8cf5276ac409c58de4f922716))
...
* **providers:** only use `mini.diff` if initialized ([#1472](https://github.com/georgeharker/codecompanion.nvim/issues/1472)) ([f7bb598](https://github.com/georgeharker/codecompanion.nvim/commit/f7bb59888b201507a43c856460d455f786c989f8))
* **providers:** register coc execute function ([#1548](https://github.com/georgeharker/codecompanion.nvim/issues/1548)) ([92ba84c](https://github.com/georgeharker/codecompanion.nvim/commit/92ba84cddf19d936809d9775884699e66a070ec4))
* **providers:** use mini.diff by default if available ([#1368](https://github.com/georgeharker/codecompanion.nvim/issues/1368)) ([127a2c1](https://github.com/georgeharker/codecompanion.nvim/commit/127a2c1614df2e8565a98e83e3567980c32d9876))
* **references:** unlock buffer when adding reference after a tool output ([#1477](https://github.com/georgeharker/codecompanion.nvim/issues/1477)) ([df44594](https://github.com/georgeharker/codecompanion.nvim/commit/df4459401180612bc5b7b167eff7133324e85f1c))
...
* **slash_commands:** update adapter reference ([#1502](https://github.com/georgeharker/codecompanion.nvim/issues/1502)) ([41108b2](https://github.com/georgeharker/codecompanion.nvim/commit/41108b2ee7d71eca50ff6c5008b30a853e14cf35))
* **snacks:** focus on floating chat windows after closing picker ([#1359](https://github.com/georgeharker/codecompanion.nvim/issues/1359)) ([6090826](https://github.com/georgeharker/codecompanion.nvim/commit/60908265b78145c7c8595d81b36792bc01cd56e5))
* **tools:** `insert_edit_info_file` tool can insert at EOF ([#1650](https://github.com/georgeharker/codecompanion.nvim/issues/1650)) ([d54a41a](https://github.com/georgeharker/codecompanion.nvim/commit/d54a41a86a510e9c728f6e460801afdf581d69da))
...
* **tools:** auto submit sends updated buffer ([#1545](https://github.com/georgeharker/codecompanion.nvim/issues/1545)) ([82f5917](https://github.com/georgeharker/codecompanion.nvim/commit/82f5917455cb7156f36daa99b2ec8049a7958ce5))
* **tools:** call subscribers after an LLM response ([#1365](https://github.com/georgeharker/codecompanion.nvim/issues/1365)) ([8dc896a](https://github.com/georgeharker/codecompanion.nvim/commit/8dc896af23c1e086aee13fe7c850eab365ad337e))
...
* **tools:** make `insert_edit_into_file` more robust for patch markers ([#1653](https://github.com/georgeharker/codecompanion.nvim/issues/1653)) ([a6e226c](https://github.com/georgeharker/codecompanion.nvim/commit/a6e226ced63d9bb5e601213e63f5cd07ad09f7cd))
...
* **tools:** tool groups are replaced properly in the chat buffer ([#1364](https://github.com/georgeharker/codecompanion.nvim/issues/1364)) ([9402ae3](https://github.com/georgeharker/codecompanion.nvim/commit/9402ae373f23269f1baef8ccc32578c128cbf2ed))
* **tools:** tools can now be deleted as references ([#1357](https://github.com/georgeharker/codecompanion.nvim/issues/1357)) ([7d0938c](https://github.com/georgeharker/codecompanion.nvim/commit/7d0938c1dc117c9c63569a388b9d091ee884d2ce))
...
* **ui:** include `kind` option in all `vim.ui.select` calls ([#1456](https://github.com/georgeharker/codecompanion.nvim/issues/1456)) ([9d8fc51](https://github.com/georgeharker/codecompanion.nvim/commit/9d8fc51a1923333de683ebf85c633fd003ad2b9b))
...
* **utils:** fallback to vim.highlight ([#1611](https://github.com/georgeharker/codecompanion.nvim/issues/1611)) ([6d62e18](https://github.com/georgeharker/codecompanion.nvim/commit/6d62e1843cbee7a181a5b86de9e4ec554650d8d9))
* **variables:** ensure special chars are matched ([#1470](https://github.com/georgeharker/codecompanion.nvim/issues/1470)) ([a682004](https://github.com/georgeharker/codecompanion.nvim/commit/a682004d4ff97c0450617975699bfc78029862be))
* **workflows:** ensure references are rendered ([#1376](https://github.com/georgeharker/codecompanion.nvim/issues/1376)) ([598a444](https://github.com/georgeharker/codecompanion.nvim/commit/598a4443e2906a382bc182e5558371ea2dd3df64))
* **workflows:** successive prompts and tools now work ([#1508](https://github.com/georgeharker/codecompanion.nvim/issues/1508)) ([0112caf](https://github.com/georgeharker/codecompanion.nvim/commit/0112caf54a79bb6cfbcb6e67cd16a3a9f18af9a7)), closes [#1496](https://github.com/georgeharker/codecompanion.nvim/issues/1496)
...
* **chat:** move `opts.goto_file_action` to `strategies.chat.opts` ([#1571](https://github.com/georgeharker/codecompanion.nvim/issues/1571)) ([cdf7721](https://github.com/georgeharker/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
* **chat:** move the `goto_file_action` to `strategies.chat.opts` ([cdf7721](https://github.com/georgeharker/codecompanion.nvim/commit/cdf772165782e55a451c0793bf4c2a89926b89bd))
...
* remove support for nvim-0.10 ([#1639](https://github.com/georgeharker/codecompanion.nvim/issues/1639)) ([5d0ef43](https://github.com/georgeharker/codecompanion.nvim/commit/5d0ef43ed822ea3341ed0989e45f2d10d57ba359))
